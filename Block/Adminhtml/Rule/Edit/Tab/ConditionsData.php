...
/**
 * @deprecated
 * Conditions Block Skeleton.
 * @codingStandardsIgnoreFile
 */
class ConditionsData extends AbstractTab
{
    ...
    protected function formInit($model)
    {
        ...
        $renderer = $this->rendererFieldset->setTemplate(
            ...
            $this->getUrl('mavenbird_rules/rule/newConditionHtml', ['form' => self::RULE_CONDITIONS_FIELDSET_NAMESPACE])
        );

...
use Mavenbird\Shiprestriction\Model\Import\Behavior\BehaviorProviderInterface;
use Mavenbird\Shiprestriction\Model\Import\Mapping\MappingInterface;
use Mavenbird\Shiprestriction\Model\Import\Validation\EncodingValidator;
use Mavenbird\Shiprestriction\Model\Import\Validation\ValidatorPoolInterface;
use Mavenbird\Shiprestriction\Model\MagentoVersion;
...
abstract class AbstractImport extends AbstractEntity
{
     ...
     * @param array $data
     * @param MagentoVersion|null $magentoVersion
     * @param ImportCounter|null $importCounter
    ...
    public function __construct(
        ...
        if (empty($entityTypeCode)) {
            throw new \Mavenbird\Shiprestriction\Exceptions\EntityTypeCodeNotSet();
        }
    ...
    protected function processValidation(array $rowData)
    {
        ...
        foreach ($this->validatorPool->getValidators() as $validator) {
            ...
            } catch (\Mavenbird\Shiprestriction\Exceptions\StopValidation $exception) {
